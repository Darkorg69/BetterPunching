...
public class Config {
    ...
    public static void initClientConfig(ForgeConfigSpec.Builder builder) {
        builder.push("Welcome to the Better Punching mod client configuration file!");
        builder.pop();
        CLIENT_CONFIG = builder.build();
    }
    public static void initCommonConfig(ForgeConfigSpec.Builder builder) {
        builder.push("Welcome to the Better Punching mod common configuration file!");
        builder.pop();
    ...
    public static void init() {
        initClientConfig(new ForgeConfigSpec.Builder());
        initCommonConfig(new ForgeConfigSpec.Builder());
        initServerConfig(new ForgeConfigSpec.Builder());
